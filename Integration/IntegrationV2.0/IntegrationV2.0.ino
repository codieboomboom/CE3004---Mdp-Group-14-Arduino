...
void setup() {
  ...
  //rotate_left(1);
//  while(true){
//    double sum_front, sum_back;
//    sum_front = sum_back = 0;
//    for (int i = 10; i >0; i--){
//      sum_front += right_front.getDistance(true);
//      sum_back += right_back.getDistance(true);
//    }
//    sum_front /= 10;
//    sum_back /=10;
//    Serial.print(sum_front);Serial.print("|");
//    //Serial.print(sum_left);Serial.print("|");
//    Serial.print(sum_back);Serial.println();
//    delay(50);
//  }
}
...
double distance_back = 0;
  ...
  while(1){
    ...
    for (int i = 10; i>0; i--){
      distance_front += right_front.getDistance(true)-5.85;
      distance_back += right_back.getDistance(true)-8.2;
    }
    distance_front /= 10;
    distance_back /= 10;
    ...
    delay(50);
    if(distance_front <6 || distance_back <6){ //If robot is too close to the rightwall
      rotate_right(90);
      delay(50);
      front_calibrate();
      delay(50);
    ...
    else if(difference >= 0.05 && distance_back < 30){ //If the robot tilts to the right 
    ...
    else if(difference <= -0.05 && distance_back  < 30){ //If the robot tilts to the left
      md.setSpeeds(rpm_to_speed_1(15),rpm_to_speed_2(-15));
        if(difference > -0.03){
        md.setBrakes(100,100);
      }
...
void front_calibrate(){
  ...
  while(distance_left != 6 || distance_right != 6){
    
    for (int i = 10; i>0; i--){
      distance_left += front_left.getDistance(true)-4.5;
      distance_right += front_right.getDistance(true)-4.5;
    }
    distance_left /= 10;
    distance_right /= 10;
    ...
    if(abs(difference <= 0.05)){
      if(distance_left > 6 && distance_right > 6){
      md.setSpeeds(rpm_to_speed_1(15),rpm_to_speed_2(15));
        if (DEBUG)
        {
          Serial.print(distance_left);
      ...
      else if(distance_left < 6 && distance_right < 6){
        md.setSpeeds(rpm_to_speed_1(-15),rpm_to_speed_2(-15));
        if (DEBUG)
        {
          Serial.print(distance_left);
