...
/*
 * This code is meant to complete checklist A.5
 * Amended from Movement_v1.2.3
 */
...
void PIDController(int directionflag)
{
  ...
  M1_speed_rpm += (E1_error_rpm * KP1) + ((E1_error_rpm - E1_prev_error_rpm) * KD1);// + (E1_sum_error_rpm * KI1);
  M2_speed_rpm += (E2_error_rpm * KP2) + ((E2_error_rpm - E2_prev_error_rpm) * KD2);// + (E2_sum_error_rpm * KI2);
