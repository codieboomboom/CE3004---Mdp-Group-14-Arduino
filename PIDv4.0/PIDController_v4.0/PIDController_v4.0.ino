//optimal voltage is 6.29
//First stable: 2.0 0.45 0.7
//Second stable: 1.75 0.45 0.8
//Try Kp = 30, 15 or 45 or 60 => whichever yields the least oscillation/ vibration. narrow down the scale both way.
//Kd is suppose to dampen the oscillation (smaller sways during the oscillation
//Kp is optional for strong reflex
...
char c; //var to hold command sent via Serial.
...
void moveForward(double distance_cm){
  //Calculate the amount of motor ticks needed to reach the distance
   ...
   speed1 = speed2 = 210; //Speed in PWM of the system.
